                        ...
                        <?php if (!empty($list)) : ?>
                            <?php foreach ($list as $category) : ?>
                                <div class="category-card">
                                    <h5 class="card-title"><?= htmlspecialchars($category['nom_categorie']); ?></h5>
                                    <p class="card-text"><?= htmlspecialchars($category['description']); ?></p>
                                    <p><strong>Number of Sites:</strong> <?= htmlspecialchars($category['nb_sites']); ?></p>
                                    <a href="sitesList.php?id=<?= $category['id']; ?>" class="btn btn-primary btn-block">View Sites</a>
                                </div>
                            <?php endforeach; ?>
                        <?php else : ?>
