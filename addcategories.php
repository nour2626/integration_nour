            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card-body">
                                <!-- Your "Add Category" form will go here -->
                                ...
                                <form method="post" action="addcategories.php">
                                    ...
                                    <div class="form-group">
                                        <label for="nb_sites">Number of Sites:</label>
                                        <input type="number" name="nb_sites" class="form-control" required>
                                    </div>
                                    <div class="form-group">
...
if (
    isset($_POST["nom_categorie"]) && isset($_POST["nb_sites"]) && isset($_POST["description"])
) {
    if (
        !empty($_POST["nom_categorie"]) && !empty($_POST["nb_sites"]) && !empty($_POST["description"])
    ) {
        // Create an instance of the categories class with the form data
        $categories = new categories(null, $_POST["nom_categorie"], $_POST["nb_sites"], $_POST["description"]);
        // Create an instance of the categoriesController class and call the addcategories method
        $categoriesC = new categoriesController();
        $categoriesC->addcategorie($categories);
        // Redirect to the categories list after successful insertion
