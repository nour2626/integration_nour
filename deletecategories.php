            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="../../pages/ui-features/updatecategories.php">update</a></li>
...
<head>
    ...
    <script>
        // Fonction de validation avec JavaScript
        function validateForm() {
            var categoryId = document.forms["deleteForm"]["category_id"].value;
            var confirmation = document.forms["deleteForm"]["confirmation"].value;

            if (categoryId == "" || confirmation == "") {
                alert("Category ID and confirmation are required.");
                return false;
            }
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <!-- Delete Category Form (HTML without HTML5 attributes) -->
                                    <form name="deleteForm" method="post" action="" onsubmit="return validateForm()">
                                        ...
                                        <div class="form-group">
                                            <input type="submit" value="Delete" class="btn btn-danger btn-rounded btn-fw">
                                        </div>
                                    </form>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Check if the form is confirmed and the ID is provided
    if (isset($_POST["category_id"]) && !empty($_POST["category_id"]) && isset($_POST["confirmation"]) && $_POST["confirmation"] === "DELETE") {
        // Retrieve the category ID from the form
        $categoryId = $_POST["category_id"];

        // Call the deleteCategory method with the ID
        $categoriesController->deletecategories($categoryId);

        // Redirect to the category list page after deletion
        header("Location: categoriesList.php"); // Redirect to the category list page
        exit; // Make sure no further code is executed after the redirect
    } else {
        echo "Error: Please provide a category ID to delete and type 'DELETE' to confirm.";
    }
}
?>
